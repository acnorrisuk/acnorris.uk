            ...
            <footer class="site-footer wrap">
               ...
               <svg style="display: none;">
                ...
                <ul class="list-reset site-footer__social">
                  <li>
                      <a href="https://twitter.com/intent/follow?original_referer=&amp;region=follow_link&amp;screen_name=acnorrisuk&amp;tw_p=followbutton&amp;variant=2.0" target="_blank" rel="noopener">
                        <svg><use xlink:href="#twitter-icon"/></svg>
                      </a>
                  </li>
                  <li>
                      <a href="https://uk.linkedin.com/in/adam-norris-ab2590a0" target="_blank" rel="noopener">
                        <svg><use xlink:href="#linkedin-icon"/></svg>
                      </a>
                  </li>
                  <li>
                      <a href="https://github.com/acnorrisuk" target="_blank" rel="noopener">
                        <svg><use xlink:href="#github-icon"/></svg>
                      </a>
                  </li>
                  <li>
                      <a href="https://codepen.io/acnorrisuk/" target="_blank" rel="noopener">
                        <svg><use xlink:href="#codepen-icon"/></svg>
                      </a>
                  </li>
                </ul>
        ...
        <script src="<?php echo get_template_directory_uri();?>/js/vendor/highlight.pack.min.js"></script>
